  ...
  scrollReveal.prototype = {
    ...
    animate: function( flag ) {
      ...
      for ( var id in self.elems ) {
        ...
        /**
         * First, letâ€™s skip any (non-reseting) elements that have completed their reveal.
         */
        ...
        if ( !self.isElemInViewport( elem ) ) {
          ...
          /**
           * The element isnâ€™t visible, so check if we should apply reset styles.
           */
          if ( elem.config.reset ) {
